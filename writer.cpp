...
static void PrintUsage(void)
{
    static const char USAGE[] =
            ...
            "\n"
            "Socket Writer: Open N socket connections to the server at address "
            "A and port P,\n"
            "then write to one connection chosen at random every D "
            "milliseconds for S seconds.\n"
            "\n"
            "    writer -n 100 -s 60 -a 192.168.0.13 -p 20260 -D 100 -t "
            "/tmp/input.txt\n"
            "\n"
            "If the value of lines is non-zero, write N lines of text instead "
            "of writing\n"
            "for a number of seconds. For example: write 1 million lines of "
            "text with a\n"
            "delay of 0 ms.\n"
            "\n"
            ...
            "  -a, --address IPA        IP Address to connect to (default: "
            "127.0.0.1)\n"
            "  -d, --delay N            Average delay between writes in "
            "milliseconds (default: 10)\n"
            "  -l, --lines N            Number of lines to write (default: 0)\n"
            "  -n, --number N           Number of socket connections to open "
            "(default: 128)\n"
            "  -p, --port P             Port number for socket connections "
            "(default: 0)\n"
            "  -s, --seconds N          Number of seconds to run the program "
            "(default: 60)\n"
            "  -t, --text-file FILE     Path to the text file to read from "
            "(default: /tmp/poll/input.txt)\n"
            "  -w, --wait N             Number of seconds to wait between "
            "creating files\n"
